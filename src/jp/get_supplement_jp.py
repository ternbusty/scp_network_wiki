...
def process_supplement(
    ...
    tmp_obj = common.create_obj_from_link(child, excludes=[parent, child], base_url=common.jp_url)
    if tmp_obj is None:
        return
...
if __name__ == '__main__':
    with open('../../yaml/jp/scp_jp.yaml') as file:
    ...
    for i in range(0, len(keys)):
        ...
        if len(new_obj[key]['links']) == 0:
            continue
        with open('../../yaml/jp/supplement_jp.yaml', 'a') as file:
