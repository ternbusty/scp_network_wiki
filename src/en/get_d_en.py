...
if __name__ == '__main__':
    url = 'http://scp-wiki.wikidot.com/archived:decommissioned-scps'
    ...
    # Save to d_scp_en
    common.iterate_and_save_link_list(hrefs, '../../yaml/en/d_scp_en')

    # Get metatitle
    lists = content_panel.find_all('li')
    texts = [li.text for li in lists]
    common.get_and_save_metatitle(hrefs, texts, '../../yaml/en/d_metatitle_en')
